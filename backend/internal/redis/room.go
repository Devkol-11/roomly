...
func SaveRoom(ctx context.Context, client *redis.Client, r *room.Room) error {
	key := "room:" + r.ID
...
func GetRoom(ctx context.Context, client *redis.Client, roomID string) (*room.Room, error) {
	key := "room:" + roomID
